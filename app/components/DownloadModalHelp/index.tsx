    ...
    >
      ...
      <div className="modal-content-container">
        ...
        <div className="modal-content-body">
          <Content>
            <p>Tesselle data lives in your browser, which means all the work you are doing is private and protected by default.</p>
            ...
            <ol>
              <li>to archive your work, version it, or share it with coworkers, and possibly to re-upload it in the tool later</li>
